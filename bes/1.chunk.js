...
DashboardModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [dashboard_component_1.DashboardComponent, _3d_secure_component_1.DSecureComponent, read_more_component_1.ReadMoreComponent, pipe_transform_directive_1.MyCurrencyFormatterDirective, pipe_card_number_directive_1.MyCardNumberFormatterDirective, pipe_transform_pipe_1.MyCurrencyPipe, pipe_card_number_pipe_1.MyCardNumberPipe, pipe_account_number_1_directive_1.AccountNumberFormatterDirective,
            pipe_account_number_1_pipe_1.AccountNumberPipe, limit_to_directive_1.LimitToDirective],
        providers: [
            emitter_service_1.EmitterService,
            pipe_transform_pipe_1.MyCurrencyPipe,
            pipe_card_number_pipe_1.MyCardNumberPipe,
            pipe_account_number_1_pipe_1.AccountNumberPipe
        ]
    })
], DashboardModule);
exports.DashboardModule = DashboardModule;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/dashboard.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interfaces_icons__ = __webpack_require__(498);
...
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/pipe-transform.pipe.js.map
...
var _a;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/3d-secure.component.js.map
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.changeModel = function (ev) {
        this.model.amount = this.mycurpipe.transform(ev);
    ...
    DashboardComponent.prototype.addToBeneficiaires = function (account, firstName, lastName) {
        if (this.hidden === true) {
            var ben = {
                "lastname": lastName,
                "firstname": firstName,
            ...
            var id = this.beneficiaires.length + 1;
            var found = this.beneficiaires.some(function (el) {
                return el.account === account;
            });
            if (!found) {
                this.beneficiaires.push(ben);
                localStorage.setItem('beneficiaire', JSON.stringify(this.beneficiaires));
            }
        }
    };
    DashboardComponent.prototype.hideBeneficiaire = function () {
        this.model.beneficiaire = "";
...
DashboardComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof pipe_transform_pipe_1.MyCurrencyPipe !== "undefined" && pipe_transform_pipe_1.MyCurrencyPipe) === "function" && _a || Object, typeof (_b = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _b || Object])
], DashboardComponent);
exports.DashboardComponent = DashboardComponent;
var _a, _b;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/dashboard.component.js.map
...
var core_1 = __webpack_require__(1);
var PADDING = "000000";
var AccountNumberPipe = (function () {
    function AccountNumberPipe() {
        // TODO comes from configuration settings
        this.PREFIX = '';
        this.DECIMAL_SEPARATOR = ".";
        this.THOUSANDS_SEPARATOR = " ";
    ...
    AccountNumberPipe.prototype.transform = function (value, fractionSize) {
        if (fractionSize === void 0) { fractionSize = 2; }
        var _a = (value || "").toString()
            .split("."), integer = _a[0], _b = _a[1], fraction = _b === void 0 ? "" : _b;
        integer = integer.replace(/\B(?=(\d{3})+(?!\d))/g, this.THOUSANDS_SEPARATOR);
    ...
    AccountNumberPipe.prototype.parse = function (value, fractionSize) {
        if (fractionSize === void 0) { fractionSize = 2; }
        var _a = (value || "").replace(this.PREFIX, "")
            .replace(this.SUFFIX, "")
            .split(this.DECIMAL_SEPARATOR), integer = _a[0], _b = _a[1], fraction = _b === void 0 ? "" : _b;
...
AccountNumberPipe = __decorate([
    core_1.Pipe({ name: "myAccountNumber" }),
    __metadata("design:paramtypes", [])
], AccountNumberPipe);
exports.AccountNumberPipe = AccountNumberPipe;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/pipe-account-number-1.pipe.js.map
...
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/pipe-card-number.pipe.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_animations__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_notifications_service__ = __webpack_require__(392);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_notifications_service__ = __webpack_require__(392);
...
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/dashboard-routing.module.js.map
...
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/emitter.service.js.map
...
var _a;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/read-more.component.js.map
...
var AccountNumberFormatterDirective = (function () {
    ...
    AccountNumberFormatterDirective.prototype.ngOnInit = function () {
        this.el.value = this.cardNumberPipe.transform(this.el.value);
    };
    AccountNumberFormatterDirective.prototype.onFocus = function (value) {
        this.el.value = this.cardNumberPipe.parse(value); // opossite of transform
    };
    AccountNumberFormatterDirective.prototype.onBlur = function (value) {
        this.el.value = this.cardNumberPipe.transform(value);
    };
    return AccountNumberFormatterDirective;
}());
__decorate([
...
], AccountNumberFormatterDirective.prototype, "onFocus", null);
__decorate([
    core_1.HostListener("blur", ["$event.target.value"]),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AccountNumberFormatterDirective.prototype, "onBlur", null);
AccountNumberFormatterDirective = __decorate([
    core_1.Directive({ selector: "[MyAccountNumberFormatter]" }),
    __metadata("design:paramtypes", [typeof (_a = typeof core_1.ElementRef !== "undefined" && core_1.ElementRef) === "function" && _a || Object, typeof (_b = typeof pipe_account_number_1_pipe_1.AccountNumberPipe !== "undefined" && pipe_account_number_1_pipe_1.AccountNumberPipe) === "function" && _b || Object])
], AccountNumberFormatterDirective);
exports.AccountNumberFormatterDirective = AccountNumberFormatterDirective;
var _a, _b;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/pipe-account-number-1.directive.js.map
...
var _a, _b;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/pipe-card-number.directive.js.map
...
MyCurrencyFormatterDirective = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof core_1.ElementRef !== "undefined" && core_1.ElementRef) === "function" && _a || Object, typeof (_b = typeof pipe_transform_pipe_1.MyCurrencyPipe !== "undefined" && pipe_transform_pipe_1.MyCurrencyPipe) === "function" && _b || Object])
], MyCurrencyFormatterDirective);
exports.MyCurrencyFormatterDirective = MyCurrencyFormatterDirective;
var _a, _b;
//# sourceMappingURL=D:/workspace/Bes_project_v1/src/pipe-transform.directive.js.map
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_push_notifications_module__ = __webpack_require__(535);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_simple_notifications_module__ = __webpack_require__(536);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__push_notifications_services_push_notifications_service__ = __webpack_require__(495);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__simple_notifications_components_simple_notifications_component__ = __webpack_require__(497);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__simple_notifications_components_notification_component__ = __webpack_require__(496);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__simple_notifications_pipes_max_pipe__ = __webpack_require__(499);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__simple_notifications_services_notifications_service__ = __webpack_require__(392);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__simple_notifications_interfaces_icons__ = __webpack_require__(498);
